...
[![Maven Central](https://img.shields.io/maven-central/v/io.kjson/kjson-stream?label=Maven%20Central)](https://central.sonatype.com/artifact/io.kjson/kjson-stream)
...
### Gradle
```groovy
    implementation "io.kjson:kjson-stream:3.6"
```
### Gradle (kts)
```kotlin
    implementation("io.kjson:kjson-stream:3.6")
